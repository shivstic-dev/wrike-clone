...
export default function DashboardLayout() {
  ...
  const navLinks = [
    ...
    (link) =>
      ['Dashboard', 'My Tasks', 'Reports'].includes(link.label) ||
      (link.label === 'Admin' && membership?.role === 'admin'),
  );
    ...
    <div className="flex h-screen overflow-hidden bg-slate-50">
      ...
      <aside
        className={clsx(
          ...
          isMobile &&
            'fixed left-0 top-0 z-40 h-full w-64 shadow-2xl transition-transform duration-300 ease-in-out',
